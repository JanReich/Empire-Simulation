...
public class SpriteSheet {
        ...
        public SpriteSheet(BufferedImage image, int tilesX, int tilesY, boolean calculate) {

            this.target = image;
            this.tileWidth = image.getWidth() / tilesX;
            this.tileHeight = image.getHeight() / tilesY;
